    ...
    Scaffold(
        ...
        floatingActionButton = {
            ExtendedFloatingActionButton(
                onClick = { onIntent(TrainingContract.Intent.ActionButton) },
                icon = {
                    Icon(
                        Icons.Default.Check,
        ...
        LazyColumn(
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            EnhancedTrainingTextField(
                                ...
                                onValueChange = {
                                    onIntent(
                                        TrainingContract.Intent.UpdateTrainingName(
                                            it
                                        )
                                    )
                                },
                            ...
                            EnhancedTrainingTextField(
                                ...
                                onValueChange = {
                                    onIntent(
                                        TrainingContract.Intent.UpdateTrainingDescription(
                                            it
                                        )
                                    )
                                },
            ...
            items(
                ...
                EnhancedExerciseItem(
                    ...
                    onDelete = { onIntent(TrainingContract.Intent.DeleteExercise(exercise.id)) },
                    ...
                    onEditToggle = {
                        onIntent(
                            TrainingContract.Intent.ToggleExerciseEdit(
                                exercise.id
                            )
                        )
                    },
                    onNameChange = { newName ->
                        onIntent(
                            TrainingContract.Intent.UpdateExerciseName(
                                id = exercise.id,
                                name = newName
                            )
                        )
                    ...
                    onImageChange = { newImage ->
                        onIntent(
                            TrainingContract.Intent.UpdateExerciseImage(
                                id = exercise.id,
                                image = newImage
                            )
                        )
                    ...
                    onObservationsChange = { newObservations ->
                        onIntent(
                            TrainingContract.Intent.UpdateExerciseObservations(
                                id = exercise.id,
            ...
            item {
                OutlinedButton(
                    onClick = { onIntent(TrainingContract.Intent.AddExercise) },
                    modifier = Modifier
                        .fillMaxWidth()
                        .height(56.dp),
